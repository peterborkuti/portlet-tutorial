...
/**
 * Provides the local service interface for Firstnames. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author peter
 * @see FirstnamesLocalServiceUtil
...
public interface FirstnamesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FirstnamesLocalServiceUtil} to access the firstnames local service. Add custom service methods to {@link permission.servicebuider.service.impl.FirstnamesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
