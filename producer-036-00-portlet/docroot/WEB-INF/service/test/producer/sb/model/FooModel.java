...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;producer_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link test.producer.sb.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link test.producer.sb.model.impl.FooImpl}.
 * </p>
 *
 * @author peter
 * @see Foo
...
public interface FooModel extends BaseModel<Foo>, GroupedModel {
	...
	@Override
	public CacheModel<test.producer.sb.model.Foo> toCacheModel();
