...
package test.producer.sb.service.base;
...
public class FooLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return FooLocalServiceUtil.addFoo((test.producer.sb.model.Foo)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return FooLocalServiceUtil.deleteFoo((test.producer.sb.model.Foo)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return FooLocalServiceUtil.updateFoo((test.producer.sb.model.Foo)arguments[0]);
		}
