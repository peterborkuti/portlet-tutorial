...
import test.producer.sb.NoSuchFooException;
import test.producer.sb.model.Foo;
import test.producer.sb.model.impl.FooImpl;
import test.producer.sb.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(test.producer.sb.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.test.producer.sb.model.Foo")));
