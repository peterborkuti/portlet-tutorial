...
/**
 * Provides the local service interface for Legacydb. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author peter
 * @see LegacydbLocalServiceUtil
...
public interface LegacydbLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegacydbLocalServiceUtil} to access the legacydb local service. Add custom service methods to {@link test.sb.service.impl.LegacydbLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
