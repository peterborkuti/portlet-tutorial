...
import hu.borkutip.lfrnevnapp.data.service.DayEntityLocalService;
...
/**
 * Provides the base implementation for the day entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hu.borkutip.lfrnevnapp.data.service.impl.DayEntityLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class DayEntityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DayEntityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link hu.borkutip.lfrnevnapp.data.service.DayEntityLocalServiceUtil} to access the day entity local service.
	 */
	...
	@Override
	public DayEntity addDayEntity(DayEntity dayEntity)
		throws SystemException {
		dayEntity.setNew(true);

		return dayEntityPersistence.update(dayEntity);
	}
	 ...
	 */
	@Override
	public DayEntity createDayEntity(long dayId) {
		return dayEntityPersistence.create(dayId);
	}
	...
	@Override
	public DayEntity deleteDayEntity(long dayId)
		throws PortalException, SystemException {
		return dayEntityPersistence.remove(dayId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DayEntity deleteDayEntity(DayEntity dayEntity)
		throws SystemException {
		return dayEntityPersistence.remove(dayEntity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DayEntity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dayEntityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dayEntityPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dayEntityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DayEntity fetchDayEntity(long dayId) throws SystemException {
		return dayEntityPersistence.fetchByPrimaryKey(dayId);
	}
	 ...
	 */
	@Override
	public DayEntity getDayEntity(long dayId)
		throws PortalException, SystemException {
		return dayEntityPersistence.findByPrimaryKey(dayId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dayEntityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DayEntity> getDayEntities(int start, int end)
		throws SystemException {
		return dayEntityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDayEntitiesCount() throws SystemException {
		return dayEntityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DayEntity updateDayEntity(DayEntity dayEntity)
		throws SystemException {
		return dayEntityPersistence.update(dayEntity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("hu.borkutip.lfrnevnapp.data.model.DayEntity",
			dayEntityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dayEntityPersistence.getDataSource();
	...
	private DayEntityLocalServiceClpInvoker _clpInvoker = new DayEntityLocalServiceClpInvoker();
}