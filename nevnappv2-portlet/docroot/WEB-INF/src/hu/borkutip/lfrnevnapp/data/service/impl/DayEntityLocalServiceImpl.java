...
public class DayEntityLocalServiceImpl extends DayEntityLocalServiceBaseImpl {
	...
	public List<DayEntity> getDatesByNameId(long nameId) throws SystemException {
		List<DayEntity> days = dayEntityPersistence.findByNameId(nameId);
		return days;
	}

	public List<NameEntity> getNamesByMonthAndDay(int month, int day) throws SystemException, NoSuchNameEntityException {
