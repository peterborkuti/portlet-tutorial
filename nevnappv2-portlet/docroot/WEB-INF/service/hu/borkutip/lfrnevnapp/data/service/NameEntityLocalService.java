...
/**
 * Provides the local service interface for NameEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Péter Borkuti
 * @see NameEntityLocalServiceUtil
...
public interface NameEntityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NameEntityLocalServiceUtil} to access the name entity local service. Add custom service methods to {@link hu.borkutip.lfrnevnapp.data.service.impl.NameEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
