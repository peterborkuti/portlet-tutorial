...
/**
 * Provides the local service interface for DayEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Péter Borkuti
 * @see DayEntityLocalServiceUtil
...
public interface DayEntityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DayEntityLocalServiceUtil} to access the day entity local service. Add custom service methods to {@link hu.borkutip.lfrnevnapp.data.service.impl.DayEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
