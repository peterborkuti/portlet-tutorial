...
import hu.borkuti.peter.scriptpp.service.NoSuchHistoryException;
import hu.borkuti.peter.scriptpp.service.model.History;
import hu.borkuti.peter.scriptpp.service.model.impl.HistoryImpl;
import hu.borkuti.peter.scriptpp.service.model.impl.HistoryModelImpl;
...
public class HistoryPersistenceImpl extends BasePersistenceImpl<History>
	...
	protected History toUnwrappedModel(History history) {
		...
		historyImpl.setCompanyId(history.getCompanyId());
		historyImpl.setGroupId(history.getGroupId());
		historyImpl.setUserId(history.getUserId());
		historyImpl.setCreateDate(history.getCreateDate());
		historyImpl.setModifiedDate(history.getModifiedDate());
		historyImpl.setLine(history.getLine());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.hu.borkuti.peter.scriptpp.service.model.History")));
