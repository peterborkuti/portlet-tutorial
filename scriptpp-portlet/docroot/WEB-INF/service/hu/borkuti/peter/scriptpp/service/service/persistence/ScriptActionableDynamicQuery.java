 ...
 * @generated
 */
public abstract class ScriptActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ScriptActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ScriptLocalServiceUtil.getService());
		setClass(Script.class);

		setClassLoader(hu.borkuti.peter.scriptpp.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("ScriptId");
	}
}