 ...
 * {@link hu.borkuti.peter.scriptpp.service.service.impl.HistoryServiceImpl} and is the
...
public class HistoryServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link hu.borkuti.peter.scriptpp.service.service.impl.HistoryServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static HistoryService getService() {
		if (_service == null) {
			...
			if (invokableService instanceof HistoryService) {
				_service = (HistoryService)invokableService;
			}
			else {
				_service = new HistoryServiceClp(invokableService);
			}
