...
/**
 * Provides the local service interface for Script. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Peter Borkuti
 * @see ScriptLocalServiceUtil
...
public interface ScriptLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ScriptLocalServiceUtil} to access the script local service. Add custom service methods to {@link hu.borkuti.peter.scriptpp.service.service.impl.ScriptLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
